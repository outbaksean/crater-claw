...
describe('getProviderStatus', () => {
  it('calls GET /api/providers/{name}/status', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/api/providers/local/status'))
    expect(result).toEqual(data)
  })
...
describe('getModels', () => {
  it('calls GET /api/providers/{name}/models', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/api/providers/local/models'))
    expect(result).toEqual(data)
  })
})
